...
Variables we_stroom t_ingesteld alarm_aan t_alarm_ingesteld alarm_gaat tijd_alarm: Prop.
...
Definition kabel := alarm_gaat -> cdsp_aan .

Definition muziekL := cdsp_lol -> verst_linel  .

Definition muziekR := cdsp_lor -> verst_liner  .

Definition kop4 := True  .

Definition kop5 := True  .

Definition kop6 := True  .
